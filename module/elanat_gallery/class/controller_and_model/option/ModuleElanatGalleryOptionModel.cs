...
namespace Elanat
{
    public partial class ModuleElanatGalleryOptionModel : CodeBehindModel
    {
        ...
        public void SaveElanatGalleryOption()
        {
            ...
            CatalogDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_gallery/catalog.xml"));
            ...
            CatalogDocument.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_gallery/catalog.xml"));
        ...
        public void SetImageList()
        {
            ...
            DirectoryInfo dirInfo = new DirectoryInfo(StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_gallery/image"));
        ...
        {
            string Path = StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_gallery/image");
            ...
            if (!System.IO.Directory.Exists(StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_gallery/image/thumb/")))
                System.IO.Directory.CreateDirectory(StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_gallery/image/thumb/"));
