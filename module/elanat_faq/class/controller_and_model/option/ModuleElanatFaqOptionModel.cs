...
namespace Elanat
{
    public partial class ModuleElanatFaqOptionModel : CodeBehindModel
    {
        ...
        public void SetValue()
        {
            ...
            ElanatFaqOptionDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_faq/option/elanat_faq_option.xml"));
        ...
        public void SaveElanatFaqOption()
        {
            ...
            ElanatFaqOptionDocument.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_faq/option/elanat_faq_option.xml"));


            XmlDocument CatalogDocument = new XmlDocument();
            CatalogDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_faq/catalog.xml"));
            ...
            CatalogDocument.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_faq/catalog.xml"));


            // Add Reference
            ReferenceClass rc = new ReferenceClass();
            rc.StartEvent("save_elanat_faq_option", "");
        ...
        public void SetFaqList()
        {
            ...
            OptionDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_faq/option/elanat_faq_option.xml"));
        ...
        public void SaveElanatFaqs()
        {
            ...
            // Add Reference
            ReferenceClass rc = new ReferenceClass();
            rc.StartEvent("save_elanat_faqs_list", "");
