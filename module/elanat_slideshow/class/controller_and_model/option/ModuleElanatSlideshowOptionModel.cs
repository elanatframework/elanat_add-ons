...
namespace Elanat
{
    public partial class ModuleElanatSlideshowOptionModel : CodeBehindModel
    {
        ...
        public IFormFile ImagePathUploadValue { get; set; }
        ...
        public void SetValue()
        {
            ...
            List<ListItem> SlideImageObjectFitListItem = new List<ListItem>();
            SlideImageObjectFitListItem.Add(new ListItem(aol.GetAddOnsLanguage("contain"), "contain"));
            SlideImageObjectFitListItem.Add(new ListItem(aol.GetAddOnsLanguage("cover"), "cover"));
            SlideImageObjectFitListItem.Add(new ListItem(aol.GetAddOnsLanguage("fill"), "fill"));
            SlideImageObjectFitListItem.Add(new ListItem(aol.GetAddOnsLanguage("unset"), "unset"));
            ...
            // Set Text Location
            List<ListItem> TextLocationListItem = new List<ListItem>();
            TextLocationListItem.Add(new ListItem(aol.GetAddOnsLanguage("right"), "right"));
            TextLocationListItem.Add(new ListItem(aol.GetAddOnsLanguage("left"), "left"));
            TextLocationListItem.Add(new ListItem(aol.GetAddOnsLanguage("center"), "center"));
            TextLocationListItem.Add(new ListItem(aol.GetAddOnsLanguage("unset"), "unset"));
            ...
            List<ListItem> ChangeSlideAnimationListItem = new List<ListItem>();
            ...
            foreach (string SlideAnimation in ChangeSlideAnimationList)
                ChangeSlideAnimationListItem.Add(new ListItem(aol.GetAddOnsLanguage(SlideAnimation), SlideAnimation));
        ...
        public void SetImportantField()
        {
            ...
            SlideshowWidthAttribute += vc.ImportantInputAttribute.GetValue("txt_SlideshowWidth");
            SlideshowHeightAttribute += vc.ImportantInputAttribute.GetValue("txt_SlideshowHeight");
            ChangeSlideDelayAttribute += vc.ImportantInputAttribute.GetValue("txt_ChangeSlideDelay");
            SlideImageObjectFitAttribute += vc.ImportantInputAttribute.GetValue("ddlst_SlideImageObjectFit");
            TextLocationAttribute += vc.ImportantInputAttribute.GetValue("ddlst_TextLocation");
            ChangeSlideAnimationAttribute += vc.ImportantInputAttribute.GetValue("ddlst_ChangeSlideAnimation");
            TextStyleAttribute += vc.ImportantInputAttribute.GetValue("txt_TextStyle");

            SlideshowWidthCssClass = SlideshowWidthCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("txt_SlideshowWidth"));
            SlideshowHeightCssClass = SlideshowHeightCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("txt_SlideshowHeight"));
            ChangeSlideDelayCssClass = ChangeSlideDelayCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("txt_ChangeSlideDelay"));
            SlideImageObjectFitCssClass = SlideImageObjectFitCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("ddlst_SlideImageObjectFit"));
            TextLocationCssClass = TextLocationCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("ddlst_TextLocation"));
            ChangeSlideAnimationCssClass = ChangeSlideAnimationCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("ddlst_ChangeSlideAnimation"));
            TextStyleCssClass = TextStyleCssClass.AddHtmlClass(vc.ImportantInputClass.GetValue("txt_TextStyle"));
        }
        ...
        public void SaveElanatSlideshowOption()
        {
            ...
            if (SlideshowUseInternalBoxValueChanged)
            {
                ...
                CatalogDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_slideshow/catalog.xml"));
                ...
                CatalogDocument.Save(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_slideshow/catalog.xml"));
            }


            // Add Reference
            ReferenceClass rc = new ReferenceClass();
            rc.StartEvent("save_elanat_slideshow_option", "");
        ...
        public List<string> GetChangeSlideAnimationList()
        {
            ...
            doc.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_slideshow/template/template.xml"));
        ...
        public void SetImageList()
        {
            ...
            OptionDocument.Load(StaticObject.ServerMapPath(StaticObject.SitePath + "add_on/module/elanat_slideshow/option/elanat_slideshow_option.xml"));
            ...
            DirectoryInfo dirInfo = new DirectoryInfo(StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_slideshow/image"));
        ...
        {
            string Path = StaticObject.ServerMapPath(StaticObject.SitePath + "client/elanat_slideshow/image");
        ...
        public void SaveElanatSlideshowImages()
        {
            ...
            // Add Reference
            ReferenceClass rc = new ReferenceClass();
            rc.StartEvent("save_elanat_slideshow_image_list", "");
